...
public class AppointmentListView extends ExpandableListView implements
		OnScrollListener {
	...
	private void init(Context context) {
		...
		headView = (LinearLayout) inflater.inflate(R.layout.appointment_head,
				null);
	...
	public void setAdapter(DriverAppointmentActivity.ListViewAdapter adapter) {
		lastUpdatedTextView.setText("最近更新:" + new Date().toLocaleString());
